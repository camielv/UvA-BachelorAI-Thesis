...
The Probabilistic Hough Transform \cite{Kiryati1991} is a feature extraction technique, which is similar to the Standard Hough Transform. After the pre-processing stage done in this case by a edge detector or a motion detector .
