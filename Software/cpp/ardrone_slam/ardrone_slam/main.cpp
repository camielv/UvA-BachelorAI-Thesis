...
int main(int argc, char *argv[])
{
	...
	MoveWindow(consoleWindow, 0, 0, 400, 400, false);
	...
	bot_ardrone ardrone(0x01, BOT_ARDRONE_INTERFACE_ARDRONELIB, SLAM_MODE_VEL | SLAM_MODE_MAP | SLAM_MODE_VISUALLOC /*SLAM_MODE_VEL | SLAM_MODE_MAP */ /* |  SLAM_MODE_MAP | SLAM_MODE_VEL | SLAM_MODE_ELEVMAP | SLAM_MODE_VISUALLOC /* | SLAM_MODE_ELEVMAP /*| SLAM_MODE_VEL_OR | SLAM_MODE_VISUALMOTION */);
